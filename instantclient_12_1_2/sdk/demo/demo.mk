...
ifeq ($(BUILD64),T)
CCFLAGS=$(CCINCLUDES) -DMAC_OSX -D_GNU_SOURCE -D_REENTRANT -g -m64 -mmacosx-version-min=10.9
LDFLAGS=-g -m64 -mmacosx-version-min=10.9
else
CCFLAGS=$(CCINCLUDES) -DMAC_OSX -D_GNU_SOURCE -D_REENTRANT -g -m32 -mmacosx-version-min=10.9
LDFLAGS=-g -m32 -mmacosx-version-min=10.9
endif

# bake into the the demo executable the full path to IC libs
ICLIBHOME_FULL_PATH=$(shell /bin/pwd -P)/$(ICLIBHOME)
LDFLAGS+=-rpath $(ICLIBHOME_FULL_PATH)
